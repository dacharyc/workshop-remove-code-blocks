...
.. literalinclude:: /code-examples/includes/example-connect/connection-string-format.sh
   :language: shell

Use the connection information you gathered to create the connection
strings for ``cluster0`` and ``cluster1``:

.. literalinclude:: /code-examples/includes/example-connect/cluster-1-2-connection-strings.sh
   :language: shell
...
.. literalinclude:: /code-examples/includes/example-connect/mongosync-connection-strings.sh
   :language: shell
...
.. literalinclude:: /code-examples/includes/example-connect/mongodb-srv-connection-strings.sh
   :language: shell
